...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" href="<?php echo e(URL::asset('css/scaffold-interface-css/main.css')); ?>">
    ...
    <body>
        <div id = "el1" class = 'container'>
            ...
            <div class="row">
                <div transition = "fade" class="col s5 animated" v-if = 'show'>
                    ...
                    <form id = 'form' method = 'post' action = '<?php echo e(URL::to("/")); ?>/scaffold/guipost'>
                ...
                <div class="col s7">
                    ...
                    <div>
                        <div class = 'center'>
                            <h5 class = "black-text thin">You work on <i><?php echo e(config('amranidev.config.package')); ?></i></h5>
                        </div>
                        <table class = 'centered highlight'>
                            ...
                            <tbody>
                                <?php foreach($scaffold as $value): ?>
                                <tr>
                                    <td><?php echo e($value->tablename); ?></td>
                                    <td><?php echo e($value->package); ?></td>
                                    <td><?php echo e($value->created_at); ?></td>
                                    <td><span class = "scaffoldv <?php echo e($toto = Schema::hasTable($value->tablename) ? 'green' : 'red'); ?> white-text"><?php echo e($toto = Schema::hasTable($value->tablename) ? 'Migrated' : 'Not migrated'); ?></span></td>
                                    <td><a href="<?php echo e(URL::to('/')); ?>/<?php echo e(lcfirst(str_singular($value->tablename))); ?>" class = 'btn-floating blue white-text'><i class = 'material-icons'>send</i></a></td>
                                    <td><a href = '#modal1' class = 'delete btn-floating pink modal-trigger' data-link = '/scaffold/guidelete/<?php echo e($value->id); ?>/'><i class = 'material-icons'>repeat</i></a></td>
                                </tr>
                                <?php endforeach; ?>
                            </tbody>
                        </table>
                        <?php echo $scaffold->render(); ?>

                        <div class="pushDown"></div>
                        <span>Scaffold-interface <span class = 'scaffoldv blue white-text'>v1.4.11</span></span><br><br>
                        ...
                        Follow @Amranidev</a>
                        <p class = 'light'>Created with love and <i class = 'material-icons'>free_breakfast</i> by Amrani Houssain <?php echo e(date("Y")); ?></p>
                    </div>
                </div>
            </div>
        </div>
        <div class="fixed-action-btn horizontal click-to-toggle" style="bottom: 45px; right: 24px;">
            ...
            <ul>
                <li><a href = "<?php echo e(URL::to('/')); ?>/scaffold/scaffoldHomePage" class="btn-floating blue tooltipped" data-position="left" data-delay="50" data-tooltip="Generate Home Page"><i class="material-icons">view_list</i></a></li>
                <li><a href = "<?php echo e(URL::to('/')); ?>/scaffold/scaffoldHomePageDelete" class="btn-floating red darken-1 tooltipped" data-position="left" data-delay="50" data-tooltip="Delete Home Page"><i class="material-icons">delete</i></a></li>
                <li><a href = "<?php echo e(URL::to('/')); ?>/scaffold/scaffoldHomePageIndex" class="btn-floating #7cb342 light-green darken-1 tooltipped" data-position="left" data-delay="50" data-tooltip="Home Page"><i class="material-icons">send</i></a></li>
                <li><a href = "<?php echo e(URL::to('/')); ?>/scaffold/rollback" class="btn-floating pink tooltipped" data-position="left" data-delay="50" data-tooltip="RollBack the Schema"><i class="material-icons">repeat</i></a></li>
                <li><a href = "<?php echo e(URL::to('/')); ?>/scaffold/migrate" class="btn-floating orange tooltipped" data-position="left" data-delay="50" data-tooltip="Migrate the Shcema"><i class="material-icons">input</i></a></li>
            </ul>
        </div>
    ...
    var scaffoldList = <?php echo $scaffoldList; ?>;
    </script>
    ...
    <script src = "<?php echo e(URL::asset('js/scaffold-interface-js/main.js')); ?>"></script>
    <script src = "<?php echo e(URL::asset('js/scaffold-interface-js/social.js')); ?>"></script>
    <script>
    <?php if(Session::has('status')): ?>
    Materialize.toast("<?php echo e(Session::get('status')); ?>", 4000)
    <?php endif; ?>
    </script>
</html>
