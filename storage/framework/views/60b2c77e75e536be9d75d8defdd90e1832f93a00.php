...
<html lang="en">
    ...
    <body>
        <div class = 'container'>
            ...
            <br>
            <form method = 'POST' action = 'http://localhost:8000/chamada'>
               ...
               <div class="form-group">
                    ...
                    <input id="data_da_chamada" name = "data_da_chamada" type="text" class="form-control">
                </div>
                ...
                <div class="form-group">
                    ...
                    <input id="presente" name = "presente" type="text" class="form-control">
                </div>
