        ...
        <div class = 'container'>
            ...
            <form method = 'POST' action = '<?php echo e($names->standardApi()); ?>/<?php echo e($names->open()); ?>$<?php echo e($names->TableNameSingle()); ?>->id<?php echo e($names->close()); ?>/update'>
                ...
                <div class="form-group">
                    ...
                    <input id="<?php echo e($value); ?>" name = "<?php echo e($value); ?>" type="text" class="form-control" value="<?php echo e($names->open()); ?>$<?php echo e($names->tableNameSingle()); ?>-><?php echo e($value); ?><?php echo e($names->close()); ?>">
                </div>
                <?php endforeach; ?>
