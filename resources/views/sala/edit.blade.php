...
<div class="container">
    <div class="row">
        <div class="col-md-10 col-md-offset-1">
            ...
            <br>
            <form method = 'POST' action = 'http://localhost:8000/sala/{{$sala->id}}/update'>
                <input type = 'hidden' name = '_token' value = '{{Session::token()}}'>

                <div class="form-group">
                    <label for="nome_da_sala">nome_da_sala</label>
                    <input id="nome_da_sala" name = "nome_da_sala" type="text" class="form-control" value="{{$sala->nome_da_sala}}">
                </div>
